...
const ProviderBookings = () => {
  ...
  // existing filters
  const [searchTerm, setSearchTerm] = useState(''); // buyer/service quick search
  ...
  // Resolve the parking space title reliably
  ...
  // Apply filters (includes NEW parkingSelection)
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="flex flex-col space-y-2 lg:space-y-0 lg:flex-row lg:space-x-2">
              <select
                ...
                className={`flex-1 px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 shadow-inner ${
                  dateFilter === 'specific' ? 'lg:w-1/2' : 'lg:w-full'
                }`}
              >
                ...
                <div className="p-6 border-b border-gray-100 dark:border-gray-700">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {/* Parking space name */}
                      <p className="text-sm font-semibold text-gray-800 dark:text-gray-200 truncate flex items-center mt-1">
